...
**Grant of Rights:** You may use, copy, and modify the Licensed Work for internal, non-production purposes (evaluation, development, testing). Production use requires a valid Cookslate Pro license key, available at https://cookslate.app.
...
For license purchases, visit https://cookslate.app.
